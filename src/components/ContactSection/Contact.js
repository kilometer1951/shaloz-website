            ...
            <section id="contact" className="contact-area bg-gray ptb_100">
                <div className="container">
                    ...
                    <div className="col-12 col-md-10 col-lg-6">
                        ...
                        <h2 className="text-capitalize">{db.themeOneContactSection.heading}</h2>
                        <p className="d-block d-sm-none mt-4">{db.themeOneContactSection.headingTexttwo}</p>
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="col-12 col-md-5">
                        ...
                        <p className="mb-3">{db.themeOneContactSection.content}</p>
                            <ul>
                                {db.themeOneContactSection.iconList.map((item, idx) => {
                                    return(
