                    ...
                    <div className="footer-top ptb_100">
                        ...
                        <div className="row">
                            ...
                            <div className="footer-items">
                                ...
                                <img className="logo" src={db.themeOneFooterSection.image} alt="" style={{width:100}}/>
                                </a>
                            ...
                            <div className="footer-items">
                                {/* Footer Title */}
                                <h3 className="footer-title mb-2">{db.themeOneFooterSection.linkText_1}</h3>
                                <ul>
                                    {db.themeOneFooterSection.footerList_1.map((item, idx) => {
                                        return(
                            ...
                            <div className="footer-items">
                                {/* Footer Title */}
                                <h3 className="footer-title mb-2">{db.themeOneFooterSection.linkText_2}</h3>
                                <ul>
                                    {db.themeOneFooterSection.footerList_2.map((item, idx) => {
                                        return(
                            ...
                            <div className="footer-items">
                                {/* Footer Title */}
                                <h3 className="footer-title mb-2">{db.themeOneFooterSection.linkText_3}</h3>
                                {/* Store Buttons */}
                                <div className="button-group store-buttons store-black d-flex flex-wrap">
                                    {db.themeOneFooterSection.footerList_3.map((item, idx) => {
                                        return(
                    ...
                    <div className="footer-bottom">
                        ...
                        <div className="row">
                            ...
                            <div className="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                                {/* Copyright Left */}
                                <div className="copyright-left">© Copyrights 2020 Shaloz All rights reserved.</div>
                                {/* Copyright Right */}
                            </div>
                            </div>
                        </div>
